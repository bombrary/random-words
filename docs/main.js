...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Choose.Distinct"] = $PS["Choose.Distinct"] || {};
  var exports = $PS["Choose.Distinct"];
  var Control_Apply = $PS["Control.Apply"];
  ...
  var swapST = function (v) {
      return function (stArr) {
          var swap = function (xi) {
              return function (xj) {
                  return function __do() {
                      Data_Array_ST.poke(v.j)(xi)(stArr)();
                      Data_Array_ST.poke(v.i)(xj)(stArr)();
                      return Data_Unit.unit;
                  };
              };
          };
          return function __do() {
              var xiMay = Data_Array_ST.peek(v.i)(stArr)();
              var xjMay = Data_Array_ST.peek(v.j)(stArr)();
              var v1 = Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(swap)(xiMay))(xjMay);
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Data_Unit.unit;
              };
              if (v1 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at Choose.Distinct (line 26, column 3 - line 31, column 10): " + [ v1.constructor.name ]);
          };
      };
  };
  var swapInfoArray = function (n) {
      return function (pickN) {
          return Data_Traversable["for"](Effect.applicativeEffect)(Data_Traversable.traversableArray)(Data_Array.range(0)(pickN - 1 | 0))(function (i) {
              return function __do() {
                  var j = Effect_Random.randomInt(i)(n - 1 | 0)();
                  return {
                      i: i,
                      j: j
                  };
  ...
  var choose = function (n) {
      return function (xs) {
          var swapMany = function (infoArr) {
              return function (stArr) {
                  return Control_Monad_ST_Internal.foreach(infoArr)(function (info) {
                      return swapST(info)(stArr);
                  });
              };
          };
          return function __do() {
              var infoArr = swapInfoArray(Data_Array.length(xs))(n)();
              var st = Data_Array_ST.withArray(swapMany(infoArr))(xs);
              return Data_Array.take(n)(st());
          };
      };
  };
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Component.Main"] = $PS["Component.Main"] || {};
  var exports = $PS["Component.Main"];
  var Affjax = $PS["Affjax"];
  var Affjax_ResponseFormat = $PS["Affjax.ResponseFormat"];
  var Choose_Distinct = $PS["Choose.Distinct"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except = $PS["Control.Monad.Except"];
  ...
  var Randomize = (function () {
      ...
      Randomize.value = new Randomize();
      return Randomize;
  })();
  var FileSelected = (function () {
      function FileSelected(value0) {
          this.value0 = value0;
      };
      FileSelected.create = function (value0) {
          return new FileSelected(value0);
      };
      return FileSelected;
  })();
  var FileLoaded = (function () {
      function FileLoaded(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      FileLoaded.create = function (value0) {
          return function (value1) {
              return new FileLoaded(value0, value1);
          };
      };
      return FileLoaded;
  })();
  ...
  var SetWords = (function () {
      function SetWords(value0) {
          this.value0 = value0;
      };
      SetWords.create = function (value0) {
          return new SetWords(value0);
      };
      return SetWords;
  })();
  ...
  var renderRandomWords = function (randomWords) {
      if (randomWords instanceof Data_Maybe.Nothing) {
          return Halogen_HTML_Elements.div_([  ]);
      };
      if (randomWords instanceof Data_Maybe.Just) {
          return Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(function (word) {
  ...
  var render = function (v) {
      ...
      }), Halogen_HTML_Properties.classes([ "randomize-btn" ]) ])([ Halogen_HTML_Core.text("\u5358\u8a9e\u3092\u751f\u6210") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "select-preset" ]) ])([ Halogen_HTML_Elements.select([ Halogen_HTML_Properties.classes([ "select-preset" ]), Halogen_HTML_Events.onValueChange(SetWords.create) ])([ Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value("nouns") ])([ Halogen_HTML_Core.text("\u540d\u8a5e") ]), Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value("verbs") ])([ Halogen_HTML_Core.text("\u52d5\u8a5e") ]), Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value("adjectives") ])([ Halogen_HTML_Core.text("\u5f62\u5bb9\u8a5e") ]), Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value("adverbs") ])([ Halogen_HTML_Core.text("\u526f\u8a5e") ]) ]) ]), Halogen_HTML_Elements.label([ Halogen_HTML_Properties.classes([ "input-file-wrap" ]) ])([ Halogen_HTML_Core.text("\u30d5\u30a1\u30a4\u30eb\u3092\u9078\u629e"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.classes([ "input-file" ]), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputFile.value), Halogen_HTML_Properties.accept([ new DOM_HTML_Indexed_InputAcceptType.AcceptMediaType("text/plain") ]), Halogen_HTML_Events.onFileUpload(Data_Unfoldable.unfoldableArray)(function (v1) {
          if (v1.length === 1) {
              return new FileSelected(Web_File_File.toBlob(v1[0]));
          };
  ...
  var initialState = function (v) {
      return {
          words: Data_Maybe.Nothing.value,
          randomWords: Data_Maybe.Nothing.value,
                      ...
                      return Control_Applicative.pure(((dictMonadAff.MonadEffect0()).Monad0()).Applicative0())(Control_Apply.apply(Data_Either.applyEither)(Control_Apply.apply(Data_Either.applyEither)(Control_Apply.apply(Data_Either.applyEither)(Data_Functor.map(Data_Either.functorEither)(function (adj) {
                          return function (n) {
                              return function (v) {
                                  return function (adv) {
                                      return {
                                          adjectives: Data_String_Utils.lines(adj.body),
                                          nouns: Data_String_Utils.lines(n.body),
                                          verbs: Data_String_Utils.lines(v.body),
                                          adverbs: Data_String_Utils.lines(adv.body)
                                      };
                                  };
                              };
                          };
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(getBasicWords(Effect_Aff_Class.monadAffAff)))(function (result) {
                  ...
                  if (result instanceof Data_Either.Right) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $32.basicWords = new Data_Maybe.Just(result.value0);
                          $32.words = new Data_Maybe.Just(result.value0.nouns);
                          return $32;
                      });
                  };
          ...
          if (v instanceof Randomize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (v1.words instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1.words instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Choose_Distinct.choose(31)(v1.words.value0)))(function (randomWords) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $38.randomWords = Data_Maybe.Just.create(randomWords);
                              return $38;
                          });
                      });
                  };
          ...
          if (v instanceof FileSelected) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.fileReader))(function (reader) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.readAsText(v.value0)(reader)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                          return Halogen_Query_Event.eventListener(Web_HTML_Event_EventTypes.load)(Web_File_FileReader.toEventTarget(reader))(function (v1) {
                              return Data_Maybe.Just.create(new FileLoaded(sid, reader));
                          });
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
          ...
          if (v instanceof FileLoaded) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe(v.value0))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.result(v.value1)))(function (result) {
                      var v1 = Control_Monad_Except.runExcept(Foreign.readString(Data_Identity.monadIdentity)(result));
                      if (v1 instanceof Data_Either.Left) {
                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log(Data_Show.show(Data_List_Types.showNonEmptyList(Data_Show.showString))(Data_Functor.map(Data_List_Types.functorNonEmptyList)(Foreign.renderForeignError)(v1.value0))));
                      };
                      if (v1 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $46.words = Data_Maybe.Just.create(Data_String_Utils.lines(v1.value0));
                              return $46;
                          }))(function () {
          ...
          if (v instanceof SetWords) {
              if (v.value0 === "nouns") {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $53.words = Data_Functor.map(Data_Maybe.functorMaybe)(function (v2) {
                          return v2.nouns;
                      })(s.basicWords);
                      return $53;
                  });
              ...
              if (v.value0 === "verbs") {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $56.words = Data_Functor.map(Data_Maybe.functorMaybe)(function (v2) {
                          return v2.verbs;
                      })(s.basicWords);
                      return $56;
                  });
              };
              if (v.value0 === "adjectives") {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      var $59 = {};
                      for (var $60 in s) {
                      ...
                      $59.words = Data_Functor.map(Data_Maybe.functorMaybe)(function (v2) {
                          return v2.adjectives;
                      })(s.basicWords);
                      return $59;
                  });
              };
              if (v.value0 === "adverbs") {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $62.words = Data_Functor.map(Data_Maybe.functorMaybe)(function (v2) {
                          return v2.adverbs;
                      })(s.basicWords);
                      return $62;
                  });
              ...
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("No value: " + v.value0));
          };
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var Component_Main = $PS["Component.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Component_Main.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();