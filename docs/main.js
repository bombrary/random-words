...
(function($PS) {
  ...
  var renderRandomWordsTable = function (randomWords) {
      ...
      throw new Error("Failed pattern match at Component.Main (line 101, column 3 - line 118, column 26): " + [ randomWords.constructor.name ]);
  };
      ...
      return function (v) {
          if (v instanceof Randomize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Component.Main (line 124, column 6 - line 132, column 16): " + [ v1.words.constructor.name ]);
              });
          };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.fileReader))(function (reader) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.readAsText(v.value0)(reader)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                          return Halogen_Query_Event.eventListener(Web_HTML_Event_EventTypes.load)(Web_File_FileReader.toEventTarget(reader))(function (e) {
          ...
          if (v instanceof FileLoaded) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe(v.value0))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.result(v.value1)))(function (result) {
                      ...
                      throw new Error("Failed pattern match at Component.Main (line 149, column 5 - line 155, column 31): " + [ v1.constructor.name ]);
                  });
              });
          };
          ...
          throw new Error("Failed pattern match at Component.Main (line 121, column 16 - line 157, column 24): " + [ v.constructor.name ]);
      };
  };
