  ...
  var split = function (n) {
      return function (xs) {
          var f = function (v) {
              ...
              return Data_Maybe.Just.create(new Data_Tuple.Tuple(Data_Array.take(n)(v), Data_Array.drop(n)(v)));
          };
          return Data_Unfoldable.unfoldr(Data_Unfoldable.unfoldableArray)(f)(xs);
      };
  };
  exports["split"] = split;
})(PS);
...
(function($PS) {
  ...
  var renderRandomWordsTable = function (randomWords) {
      if (randomWords instanceof Data_Maybe.Nothing) {
          return Halogen_HTML_Elements.div_([  ]);
      };
      if (randomWords instanceof Data_Maybe.Just) {
          return Halogen_HTML_Elements.table_(Data_Functor.map(Data_Functor.functorArray)(function (rows) {
              return Halogen_HTML_Elements.tr_(Data_Functor.map(Data_Functor.functorArray)(function (word) {
                  return Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(word) ]);
              })(rows));
          })(Util.split(5)(randomWords.value0)));
      };
      throw new Error("Failed pattern match at Component.Main (line 100, column 3 - line 117, column 26): " + [ randomWords.constructor.name ]);
  };
  var render = function (v) {
      return Halogen_HTML_Elements.main([  ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.classes([ "logo" ]), Halogen_HTML_Properties.src("logo.svg") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "random-words" ]) ])([ renderRandomWordsTable(v.randomWords) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
          return new Data_Maybe.Just(Randomize.value);
      }), Halogen_HTML_Properties.classes([ "randomize-btn" ]) ])([ Halogen_HTML_Core.text("\u30e9\u30f3\u30c0\u30e0\u3092\u3082\u3046\u4e00\u5ea6\u3002") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputFile.value), Halogen_HTML_Properties.accept([ new DOM_HTML_Indexed_InputAcceptType.AcceptMediaType("text/plain") ]), Halogen_HTML_Events.onFileUpload(Data_Unfoldable.unfoldableArray)(function (v1) {
          if (v1.length === 1) {
              return Data_Maybe.Just.create(new FileSelected(Web_File_File.toBlob(v1[0])));
          };
          return Data_Maybe.Nothing.value;
      }) ]) ]);
  };
                  ...
                  if (v1.words instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Choose_Distinct.choose(31)(v1.words.value0)))(function (randomWords) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $21.randomWords = Data_Maybe.Just.create(randomWords);
                              return $21;
                          });
                      });
                  };
                  throw new Error("Failed pattern match at Component.Main (line 123, column 6 - line 131, column 16): " + [ v1.words.constructor.name ]);
              });
          };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.fileReader))(function (reader) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.readAsText(v.value0)(reader)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                          return Halogen_Query_EventSource.eventListenerEventSource(dictMonadAff)(Web_HTML_Event_EventTypes.load)(Web_File_FileReader.toEventTarget(reader))(function (e) {
          ...
          if (v instanceof FileLoaded) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe(v.value0))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.result(v.value1)))(function (result) {
                      var v1 = Control_Monad_Except.runExcept(Foreign.readString(result));
                      ...
                      if (v1 instanceof Data_Either.Right) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $29.words = Data_Maybe.Just.create(Data_String_Utils.lines(v1.value0));
                              return $29;
                          }))(function () {
                              return handleAction(dictMonadAff)(Randomize.value);
                          });
                      };
                      throw new Error("Failed pattern match at Component.Main (line 148, column 5 - line 154, column 31): " + [ v1.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.Main (line 120, column 16 - line 154, column 31): " + [ v.constructor.name ]);
      };
  };
